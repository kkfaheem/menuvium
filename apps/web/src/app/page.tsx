                            ...
                            >
                                <div className="hero-live-visual relative">
                                    <div className="hero-stage relative rounded-[2rem] p-1.5 sm:p-2">
                                        ...
                                        <div className="hero-qr-card absolute left-1/2 top-[10%] z-30 w-[24%] -translate-x-1/2 rounded-[0.42rem] p-[0.14rem] sm:w-[24%]">
                                            <div className="hero-mockup-label">Dynamic QR</div>
                                            <div className="hero-qr-grid rounded-[0.3rem]">
                                                <Image
                                                    src={heroQrImage}
                                                    alt="Dynamic QR code"
                                                    fill
                                        ...
                                        <div className="hero-stack-phone absolute -bottom-12 left-[7%] z-20 w-[24.6%] rounded-[1.0rem] p-[0.14rem] sm:-bottom-12 sm:w-[24.6%]">
                                            <div className="hero-mockup-label">Guest View</div>
                                            <div className="hero-phone-screen relative overflow-hidden rounded-[1.05rem]">
                                        ...
                                        <div className="hero-stack-phone hero-stack-phone-ar absolute -bottom-12 left-[66%] z-20 w-[24.6%] rounded-[1.3rem] p-[0.14rem] sm:-bottom-12 sm:w-[24.6%]">
