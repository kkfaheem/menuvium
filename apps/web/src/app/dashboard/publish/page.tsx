...
import { Building2, ChevronDown, ArrowRight, Loader2, QrCode } from "lucide-react";
...
export default function PublishPage() {
    ...
    useEffect(() => {
        if (selectedMenu) {
            router.push(`/dashboard/menus/${selectedMenu}/publish`);
        }
    }, [selectedMenu, router]);
            ...
            {hasNoOrgs ? (
                <Card className="text-center">
                    <CardHeader>
                        ...
                        <CardDescription>Create a company first to publish menus.</CardDescription>
                    </CardHeader>
                </Card>
            ) : (
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Pick the menu you want to publish and share via QR.</CardDescription>
                    </CardHeader>
